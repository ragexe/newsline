...
<table width="100%" cellspacing="0" cellpadding="10" border="0">
  <tr>
    <td width="25%" valign="bottom">
      <!-- "На главную" -->
      <ul><li><a href=/main.jsp>На главную</a></li></ul>
    </td>
    ...
    <td width="25%" valign="top">
      ...
      <ul>
        <core:forEach var="page1" items="${result}">
          <li><a href=/main.jsp?sect=<core:out value="${page1.id}"/>><core:out value="${page1.title4menu}"/></a></li>
          ...
          <core:if test="${param.sect == page1.id}">
            ...
            <ul>
              <core:forEach var="page2" items="${result}">
                <li><a href=/main.jsp?sect=<core:out value="${page1.id}"/>&subsect=<core:out value="${page2.id}"/>><core:out value="${page2.title4menu}"/></a></li>
              </core:forEach>
            </ul>
          </core:if>
        </core:forEach>
